...
uint256 hashGenesisBlock("0x00000d691ed86a48c305b83be8b6890ed544ee5cf40bd839454217e5f3d0c9ff");
static const unsigned int timeGenesisBlock = 1386455387;
...
static const int64 nGenesisBlockRewardCoin = 512 * COIN;
static const int64 nBlockRewardStartCoin = 512 * COIN;
static const int64 nBlockRewardMinimumCoin = .0001 * COIN;
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Unioncoin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0x6139bbbb4bd2b3b885128ca30ea185fe34dc16fefab0c2de971f4007750be025 "));
